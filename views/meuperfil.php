...
<body>
    ...
    <div class="categoria">
        <a href="" class="categoria">
            <h1> <img id="dois" src="../imagens/icons8-pessoa-do-sexo-masculino-48 (1).png" alt="" width="30px">Minha
                Conta</h1>
        </a>
        <a href="" class="categoria">
            <h1> <img id="dois" src="../imagens/icons8-heart-32.png" alt="">Lista de Desejo</h1>
        </a>
        <a href="" class="categoria">
            <h1> <img id="dois" src="../imagens/list.png" alt="" width="30px">Categoria</h1>
        </a>
        <a href="" class="categoria">
            <h1> <img id="dois" src="../imagens/icons8-caixa-vazia-50.png" alt="" width="30px">Produtos</h1>
        </a>
    </div>
    <div class="color">
        <h1 class="usuario">Nome do usuario:</h1> 
        <h2  class="usuario">Nome:</h2>
        <h2  class="usuario">Email:</h2> 
        <h2  class="usuario">Número de telefone:</h2>  
        <h2  class="usuario">Sexo:</h2>
        <h2  class="usuario">Nome/CPF/
            Data de nascimento:</h2>
