    ...
    <main>
        <section id="banner">
            <div id="txt-banner">
                ...
                <p>Desconto em toda coleção verão</p>
            </div>
        </section>
        <section class="conteudo">
            <h1>Desconto em toda coleção de verão</h1>
            <div class="card-container">
                <div class="card">
                    <div class="card-img">
                        <img src="../imagens/S01-Feminino-D1.gif" alt="" width="300px" height="200px">
                    </div>
        ...
        <section class="conteudo">
            <div class="card-container">
                <div class="card">
                    <div class="card-img">
                        <img src="../imagens/S01-Feminino-D1.gif" alt="" width="200px" height="200px">
                    </div>
                    <div class="card-content">
